...
def generate_launch_description():
    ...
    map_dir = LaunchConfiguration(
        'map',
        default=os.path.join(pkg_path, 'maps', 'hanyang_5.yaml')
    )

    param_file_name = 'navigation2_1.yaml'
    #param_file_name = 'tracer.yaml'
    ...
    return LaunchDescription([
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([os.path.join(bringup_pkg_path, 'launch'), '/tracer_base.launch.py']),
        ),
