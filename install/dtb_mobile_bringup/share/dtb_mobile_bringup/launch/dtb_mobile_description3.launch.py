...
def generate_launch_description():
    ...
    base_2_laser_node = Node(package='tf2_ros',
    ...
    #urdf 활성화 
    # urdf = get_package_share_directory('dtb_urdf')
    # urdf_cmd = IncludeLaunchDescription(
    #     PythonLaunchDescriptionSource(os.path.join(urdf,'launch','view_dtb_mobile.launch.py'))
    # )
